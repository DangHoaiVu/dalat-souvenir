import { mapCategoryRow, mapProductRow, type SupabaseProductRow } from "@/features/products/mappers";
import { supabase, createAdminSupabaseClient } from "@/lib/supabase/client";
